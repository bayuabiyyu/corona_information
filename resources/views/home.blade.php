                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Jumlah Pasien (Indonesia)</div>
                                    ...
                                    <caption>* Data diambil dari pihak ke-3 yang terintegrasi dengan kemenkes</caption>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="bg-dark text-white">
                                                ...
                                                <td>{{ array_sum( array_column(array_column($response['data_provinsi'], 'attributes'), 'Kasus_Posi') ) }}</td>
                                                <td>{{ array_sum( array_column(array_column($response['data_provinsi'], 'attributes'), 'Kasus_Semb') ) }}</td>
                                                <td>{{ array_sum( array_column(array_column($response['data_provinsi'], 'attributes'), 'Kasus_Meni') ) }}</td>
                                                <td>{{ array_sum( array_column(array_column($response['data_provinsi'], 'attributes'), 'Kasus_Posi') ) - array_sum( array_column(array_column($response['data_provinsi'], 'attributes'), 'Kasus_Semb') ) - array_sum( array_column(array_column($response['data_provinsi'], 'attributes'), 'Kasus_Meni') ) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
